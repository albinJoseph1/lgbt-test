...
class Agent(ScrapAgent):
    def __init__(self, chrome, storage = None):
        ...
        self.companyName = "British Business Bank"
        self.ownerUsername = "britishbusinessbank"
        self.scrapPageURL = "https://careers.british-business-bank.co.uk/jobs/indeed_feed.xml"
        self.jobTrackingVariable = "job_board&utm_source=lgbtjobs"
    ...
    def loadJobs(self):
        ...
        try:
            for job in self.jobsContainer.findall('job'):
                ...
                self.job.setLink(apply_link, trackingVariable=self.jobTrackingVariable)
