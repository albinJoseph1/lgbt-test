...
class Agent(ScrapAgent):
    def __init__(self, storage = None):
        ...
        self.companyName = "Discovery"
        self.ownerUsername = "discovery"
        self.scrapPageURL = "https://www.discoverycareers.uk/upload/xmljobs/xmlJobs.xml"
