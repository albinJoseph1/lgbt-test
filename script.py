...
project_dir = '/home/yatnam/projects/lgbtjobs/script/dir'
companies_dir = os.path.join(project_dir, 'Companies')
main_branch = 'main'
csv_file = '/home/yatnam/projects/lgbtjobs/script/dir/remove.csv'
...
def process_company(company_name):
    ...
    run_command(f"git commit -m 'Removed Agent : {company_name} directory'")
